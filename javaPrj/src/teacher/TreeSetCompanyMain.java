...
이름 : 오름차순
사원_정우성,과장_현빈,부장_원빈,과장_장동건,사장_장서건,대리_정남성,대리_정좌성,부장_이효리,사원_삼효리,과장_한가인,대리_두가인
...
class ComTreeMem implements Comparator {
	...
	public int compare(Object o1, Object o2) {
		...
		// int res = GradeSort.valueOf(me.grade).ordinal() -
		// GradeSort.valueOf(you.grade).ordinal();
