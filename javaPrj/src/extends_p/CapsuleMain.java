...
class CapMember {
	...
	//캡슐화 - 멤버변수를 모두 은닉(private) 하고 메소드로 접근(public) 하는 
	//변수 (메모리공간) 의 직접 접근을 제한 하기 위해 private 사용
	//메소드 - 접근 허용을 위해서는 public 사용
...
public class CapsuleMain {
	...
	public static void main(String[] args) {
		...
		//cm.pname = "홍길동"; 멤버필드 직접 접근 불가 (private때문)
