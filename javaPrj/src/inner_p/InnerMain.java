...
class ClaOuter {
	...
	void meth_1() {
		System.out.println("outer_meth_1() 실행"+a+", "+b);
	}
	...
	void mmm() {
		...
		//inner의 private 접근 가능
		System.out.println(mmm1.a+", "+mmm1.d+", "+mmm1.e); //e가 중요! private 으로 생성했기 때문
		mmm1.meth_1();
		mmm1.meth_4();
		mmm1.meth_5();	//5가 중요! private 으로 생성했기 때문
	...
	class InnMem {
		...
		void meth_4() {
			...
			System.out.println("InnMem_meth_4() 끝");
		}
...
public class InnerMain {
	...
	public static void main(String[] args) {
		...
		// outer클래스명.inner클래스명 생성 불가
		//im1 = new ClaOuter.InnMem();
