...
class ClaConst {
	...
	// 생성자 정의
	//멤버변수 초기화 (주 목적)
	//기본 생성자 - 생성자 명시 할 경우 기본생성자 필요한 경우에는 기본생성자도 명시해야한다. 
	ClaConst(){
...
public class ConstructorMain {
	...
	public static void main(String[] args) {
		ClaConst cc1 =  new ClaConst();	// 생성자 생성시 최초 1회만 호출 가능
		System.out.println("---------------------------");
		ClaConst cc2 =  new ClaConst(234);
		System.out.println("---------------------------");
		cc1.ppp();
		cc2.ppp();
		//cc2.ClaConst(234);   생성자 재호출 불가
		//cc2.new ClaConst(234);
		//cc2.ClaConst();  메소드 호출임 - 생성자와 혼동하지말것!
		System.out.println("---------------------------");
