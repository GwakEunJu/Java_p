...
public class EnumMain {
	...
	public static void main(String[] args) {
		...
		//String ttt =a1; 문자열로 직접 대입 불가
		System.out.println(a1.name());
		String ttt =a1.name();	//열거 상수 이름을 문자열로 리턴
		System.out.println(a1.ordinal());	//인덱스 번호
		...
		BBB b1 = BBB.PARK;
		//BBB b2 = new BBB("송혜고",45,false);  인스턴스 생성하여 대입불가
		System.out.println(b1);
		System.out.println(b1.name);
		System.out.println(b1.age);
		System.out.println(b1.marriage);
		b1.name = "박찬호";	// 열거 상수의 멤버필드 변경 가능
		b1.age = 54;
		System.out.println(b1);
		b1.metht(123);
		...
		System.out.println(b1.name());
		ttt =b1.name();	//열거 상수 이름을 문자열로 리턴
		System.out.println(b1.ordinal());	//인덱스 번호
