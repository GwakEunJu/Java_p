...
public class SpreadMain {
	...
	/* 배열을 매개변수로 받는 메소드와 가변매개변수는 같은 메소드 (가변매개변수와 배열변수 같이 메소드 정의 불가)
	void meth(int [] arr) {
		//int [] arr;
		//원소들을 배열로 변환하여 매개변수로 대입
		//배열을 매개변수로 대입하는 것도 가능
	...
	public SpreadMain() {
		...
		meth(new int [] {111,222,333}); //int [] arr = {111,222,333};
		meth_a(new int [] {111,222,333});
		//meth_a(10,20,30,40,50); 가변매개변수 대입 불가
