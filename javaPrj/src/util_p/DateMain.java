...
public class DateMain {
	...
	public static void main(String[] args) {
		...
		//Thu Jan 01 09:00:00 KST 1970 시차때문에 한국시간으로 변경되면서 9시간 추가
		Date dd5 = new Date(0);// 1970-1-1  0:0:0 기준
							   // 1/1000씩 1증가 1초가 증가하려면 1000이 올라가야함	
		...
		System.out.println(today.getTime()); //오늘날짜의 타임슽탬프 1749523512341
		System.out.println(1749523512341L/1000/60/60/24/365+1970);
