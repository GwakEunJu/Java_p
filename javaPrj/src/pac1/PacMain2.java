...
class DDDChild extends DDD {
	void meth_c() {
		...
		// 부모클래스 : 다른패키지인 경우 - public, protected 접근 가능
		// default(생략), private 접근 불가
...
class Par {
	...
	void meth_5() {
		...
		//클래스 내부: : public, protected, dafault, private 모두 접근 가능 
...
class Child extends Par {
	void meth_c() {
		...
		//같은 패키지인 경우 public, protected, default(생략) 접근 가능
		//				private 접근 불가	
