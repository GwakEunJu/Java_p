...
패키지명부터 전부 기재 : pec1.FFF p1f = new pec1.FFF();
...
//		EEE p2d = new EEE();
		...
		System.out.println("pla : " + pla.a + ", " + pla.b);
		pla.meth_1();
		System.out.println("plb : " + plb.a + ", " + plb.b);
		plb.meth_1();
		System.out.println("plc : " + plc.a + ", " + plc.b);
		plc.meth_1();
//		System.out.println("p2e : " + p2e.a);
//		p2e.meth_1();

		// 다른 패키지로 생성된 인스턴스 public 만 접근 가능
