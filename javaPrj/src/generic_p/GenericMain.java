...
public class GenericMain {
	...
	public static void main(String[] args) {
		...
		System.out.println((int) a2.aa - 456); // 형변환 필요 Object 때문
		...
		// System.out.println("b1 : "+b1.aa.indexOf("아")); --> Object 이므로 불가

		System.out.println("b2 : " + b2);
		System.out.println("b2.aa : " + b2.aa.indexOf("풍")); // Generic 으로 String 인식
